...
svga_poll(void *p)
{
    ...
    //psakhis
    if (svga->vc == svga->vsyncstart && !svga->override) {   
        ...
        if (switchres_interlace_tmp != switchres_interlace || switchres_width_tmp != switchres_width || switchres_height_tmp != switchres_height) {
            switchres_switch = 1;
        ...
        if (abs(switchres_freq_tmp - switchres_freq) > 0.1) {
            switchres_switch = 1;	
            switchres_freq = switchres_freq_tmp;        	
        }	             
    }
